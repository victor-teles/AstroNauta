declare module 'virtual:astronauta/user-config' {
	const Config: import('./types').StarlightConfig;
	export default Config;
}
declare module 'virtual:astronauta/project-context' {
	export default { root: string, srcDir: string };
}

declare module 'virtual:astronauta/user-css' {}

declare module 'virtual:astronauta/user-images' {
...
declare module 'virtual:astronauta/components' {
	...
	export const ThemeToggle: typeof import('./components/ThemeToggle.astro').default;
