		...
		({ addBase, theme, config }) => {
			...
			addBase({
				...
				':root': {
					...
					'--nta-font': theme('fontFamily.sans'),
					'--nta-font-mono': theme('fontFamily.mono'),
					// Dark mode Starlight theme variables.
					'--nta-color-white': theme('colors.white'),
					'--nta-color-gray-1': theme('colors.gray.200'),
					'--nta-color-gray-2': theme('colors.gray.300'),
					'--nta-color-gray-3': theme('colors.gray.400'),
					'--nta-color-gray-4': theme('colors.gray.600'),
					'--nta-color-gray-5': theme('colors.gray.700'),
					'--nta-color-gray-6': theme('colors.gray.800'),
					'--nta-color-black': theme('colors.gray.900'),
					'--nta-color-accent-low': themeAccent(950, '#1e1b4b'),
					'--nta-color-accent': themeAccent(600, '#4f46e5'),
					'--nta-color-accent-high': themeAccent(200, '#c7d2fe'),
					// Light mode Starlight theme variables
					'&[data-theme="light"]': {
						'--nta-color-white': theme('colors.gray.900'),
						'--nta-color-gray-1': theme('colors.gray.800'),
						'--nta-color-gray-2': theme('colors.gray.700'),
						'--nta-color-gray-3': theme('colors.gray.500'),
						'--nta-color-gray-4': theme('colors.gray.400'),
						'--nta-color-gray-5': theme('colors.gray.300'),
						'--nta-color-gray-6': theme('colors.gray.200'),
						'--nta-color-gray-7': theme('colors.gray.100'),
						'--nta-color-black': theme('colors.white'),
						'--nta-color-accent-low': themeAccent(200, '#c7d2fe'),
						'--nta-color-accent': themeAccent(600, '#4f46e5'),
						'--nta-color-accent-high': themeAccent(900, '#312e81'),
					},
				},
			});
		},
