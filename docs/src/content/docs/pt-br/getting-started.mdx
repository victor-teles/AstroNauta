...
Você pode ver uma lista completa das mudanças feitas para cada versão no [histórico de mudanças do Starlight](https://github.com/withastro/starlight/blob/main/packages/astronauta/CHANGELOG.md).
