...
[Starlight Değişim Günlüğü](https://github.com/withastro/starlight/blob/main/packages/astronauta/CHANGELOG.md)'nde her yayın içindeki değişikliklerin tümünü listeleyebilirsin.
