...
Anda dapat melihat daftar lengkap perubahan-perubahan yang dilakukan dalam setiap rilis di [_changelog_](https://github.com/withastro/starlight/blob/main/packages/astronauta/CHANGELOG.md).
